...
const BlogPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-yellow-50 via-orange-100 to-yellow-200 p-4 sm:p-6 md:p-12 pt-12 md:pt-24">
          ...
          >
            ...
            <div className="flex flex-col justify-between p-4 sm:p-6 md:p-8 h-full">
              ...
              <Link href={`/Blog/${post.id}`}
                className="text-yellow-600 font-medium hover:underline transition-all duration-300">
                  Read More
